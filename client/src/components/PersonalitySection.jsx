...
const PersonalitySection = ({ onResponseChange, responses }) => {
 const questions = questionsData.personality;
  ...
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Big Five Personality Assessment</h2>
        <p className="text-gray-600">Rate each statement on a scale of 1-5 (Disagree to Agree)</p>
      </div>
